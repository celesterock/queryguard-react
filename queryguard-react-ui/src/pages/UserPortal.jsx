...
>
  Log Out
      ...
      <section id="dashboard" className="card">
        ...
        <Link to="/dashboard" className="button" onClick={() => navigate('/dashboard')}>Go to Dashboard</Link>
      </section>

      <section id="tutorials" className="card">
        <h3>Setup & Tutorials</h3>
        <p>Learn how to integrate QueryGuard, analyze logs, and configure settings.</p>
        <Link to="/tutorials" className="button">View Tutorials</Link>
      </section>
